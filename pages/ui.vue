...
const pillsSettingsModel = ref<string[]>(['icon'])
...
<template>
  <div>
    ...
    <SectionMain>
      <CardBox class="shadow-2xl md:w-7/12 lg:w-5/12 xl:w-4/12 md:mx-auto">
        <div
    ...
    <SectionMain>
      <div class="space-y-12">
        <CardBox
          class="shadow-2xl cursor-pointer md:w-7/12 lg:w-5/12 md:mx-auto"
          is-hoverable
