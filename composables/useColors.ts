import type { ButtonColors, ButtonVariant, Colors } from '~/types'
...
export const useColors = () => {
  ...
  const colorsBgLight: Record<Colors, string> = {
  ...
  const colorsText: Record<Colors, string> = {
  ...
  const colorsOutline: Record<Colors, string[]> = {
  ...
  const getButtonColor = ({
    ...
    const colors: Record<string, Partial<ButtonColors>> = {
      ring: {
